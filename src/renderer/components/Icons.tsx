...
export const AppsIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const SpinnerIcon: React.FC<IconProps> = ({ className = "w-10 h-10" }) => (
  <div className={`animate-spin border-4 border-zima-blue border-t-transparent rounded-full ${className}`}></div>
);
